...
$("#Motherboard_price_input").on("change", function (e) {
  	$("#TotalPrice_input").val((($(this).val()) * ($("#Motherboard_ks_input").val())) + (($("#GPU_ks_input").val()) * ($("#GPU_price_input").val())) + (($("#CPU_ks_input").val()) * ($("#CPU_price_input").val())) + (($("#RAM_ks_input").val()) * ($("#RAM_price_input").val())))});
 
$("#RAM_ks_input").on("change", function (e) {
	 $("#RAM_componentprice_input").val(($(this).val()) * ($("#RAM_price_input").val()))});
  
$("#RAM_ks_input").on("change", function (e) {
  	$("#TotalPrice_input").val((($(this).val()) * ($("#RAM_price_input").val())) + (($("#GPU_ks_input").val()) * ($("#GPU_price_input").val())) + (($("#CPU_ks_input").val()) * ($("#CPU_price_input").val())) + (($("#Motherboard_ks_input").val()) * ($("#Motherboard_price_input").val())))});
 
$("#RAM_price_input").on("change", function (e) {
	 $("#RAM_componentprice_input").val(($(this).val()) * ($("#RAM_ks_input").val()))});
  
$("#RAM_price_input").on("change", function (e) {
  	$("#TotalPrice_input").val((($(this).val()) * ($("#RAM_ks_input").val())) + (($("#GPU_ks_input").val()) * ($("#GPU_price_input").val())) + (($("#CPU_ks_input").val()) * ($("#CPU_price_input").val())) + (($("#Motherboard_ks_input").val()) * ($("#Motherboard_price_input").val())))});
});