namespace FSS.Omnius.Modules.Migrations.MSSQL
{
    ...
    public partial class cascadeTriggers : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.Entitron_DbRelation", "SourceColumnId", "dbo.Entitron_DbColumn", "Id");
            AddForeignKey("dbo.Entitron_DbRelation", "SourceTableId", "dbo.Entitron_DbTable", "Id");
            AddForeignKey("dbo.Entitron_DbRelation", "TargetColumnId", "dbo.Entitron_DbColumn", "Id");
            AddForeignKey("dbo.Entitron_DbRelation", "TargetTableId", "dbo.Entitron_DbTable", "Id");
            ...
            Sql("CREATE TRIGGER [TRG_C:Entitron_DbColumn] ON [Entitron_DbColumn] INSTEAD OF DELETE AS BEGIN DELETE FROM [Entitron_DbRelation] WHERE [SourceColumnId] IN (SELECT [Id] FROM deleted) OR [TargetColumnId] IN (SELECT [Id] FROM deleted); DELETE FROM [Entitron_DbColumn] WHERE [Id] IN (SELECT [Id] FROM deleted); END");
            ...
            Sql("CREATE TRIGGER [TRG_C:Entitron_DbTable] ON [Entitron_DbTable] INSTEAD OF DELETE AS BEGIN DELETE FROM [Entitron_DbRelation] WHERE [SourceTableId] IN (SELECT [Id] FROM deleted) OR [TargetTableId] IN (SELECT [Id] FROM deleted); DELETE FROM [Entitron_DbColumn] WHERE [DbTableId] IN (SELECT [Id] FROM deleted); DELETE FROM [Entitron_DbIndex] WHERE [DbTableId] IN (SELECT [Id] FROM deleted); DELETE FROM [Entitron_DbTable] WHERE [Id] IN (SELECT [Id] FROM deleted); END");
        ...
        public override void Down()
        {
            ...
            AddForeignKey("dbo.Entitron_DbRelation", "TargetTableId", "dbo.Entitron_DbTable", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Entitron_DbRelation", "TargetColumnId", "dbo.Entitron_DbColumn", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Entitron_DbRelation", "SourceTableId", "dbo.Entitron_DbTable", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Entitron_DbRelation", "SourceColumnId", "dbo.Entitron_DbColumn", "Id", cascadeDelete: true);
            ...
            Sql("CREATE TRIGGER [dbo].[Trigger_ApplicationsToMetablockANDWorkFlow_CASCADE] ON [dbo].[Master_Applications] INSTEAD OF DELETE AS BEGIN DELETE FROM [dbo].[Tapestry_WorkFlow] WHERE [ApplicationId] IN (SELECT Id FROM deleted);UPDATE [dbo].[TapestryDesigner_Metablocks] SET [ParentMetablock_Id] = NULL WHERE [ParentAppId] IN (SELECT Id FROM deleted);DELETE FROM [dbo].[TapestryDesigner_Metablocks] WHERE [ParentAppId] IN (SELECT Id FROM deleted);DELETE FROM [dbo].[Entitron_DbSchemeCommit] WHERE [ApplicationId] IN (SELECT Id FROM deleted);UPDATE [dbo].[Persona_ADgroups] SET [ApplicationId] = NULL WHERE [ApplicationId] IN (SELECT Id FROM deleted);DELETE FROM [dbo].[MozaicEditor_Pages] WHERE [ParentApp_Id] IN (SELECT Id FROM deleted);UPDATE [dbo].[Persona_Users] SET [DesignAppId] = NULL WHERE [DesignAppId] IN (SELECT Id FROM deleted);DELETE FROM [dbo].[Master_Applications] WHERE Id IN (SELECT Id FROM deleted); END");
