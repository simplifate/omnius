namespace FSS.Omnius.Modules.Migrations
{
    ...
    public partial class RemoveCascade : DbMigration
    {
        public override void Up()
        {
            DropForeignKey("dbo.TapestryDesigner_ConditionSets", "FK_dbo.TapestryDesigner_ConditionSets_dbo.TapestryDesigner_ResourceItems_TapestryDesignerResourceItem_Id");
            DropForeignKey("dbo.TapestryDesigner_ConditionSets", "FK_dbo.TapestryDesigner_ConditionSets_dbo.TapestryDesigner_WorkflowItems_TapestryDesignerWorkflowItem_Id");
            DropForeignKey("dbo.TapestryDesigner_WorkflowItems", "FK_dbo.TapestryDesigner_WorkflowItems_dbo.TapestryDesigner_Blocks_TargetId");
            DropForeignKey("dbo.Tapestry_ResourceMappingPairs", "FK_dbo.ResourceMappingPairs_dbo.Tapestry_Blocks_Block_Id");
            ...
            AddForeignKey("dbo.Persona_User_Role", "RoleId", "dbo.Persona_AppRoles", "Id");
            ...
            AddForeignKey("dbo.TapestryDesigner_ConditionSets", "ParentAppId", "dbo.Master_Applications", "Id");
            ...
            AddForeignKey("dbo.TapestryDesigner_ConditionSets", "TapestryDesignerResourceItem_Id", "dbo.TapestryDesigner_ResourceItems");
            AddForeignKey("dbo.TapestryDesigner_ConditionSets", "TapestryDesignerWorkflowItem_Id", "dbo.TapestryDesigner_WorkflowItems");
            AddForeignKey("dbo.TapestryDesigner_WorkflowItems", "TargetId", "dbo.TapestryDesigner_Blocks");
            ...
            Sql("CREATE TRIGGER [TRG_C:MozaicBootstrap_Page] ON [MozaicBootstrap_Page] INSTEAD OF DELETE AS BEGIN DELETE FROM [MozaicBootstrap_Components] WHERE [MozaicBootstrapPageId] IN (SELECT [Id] FROM deleted); DELETE FROM [Mozaic_Js] WHERE [MozaicBootstrapPageId] IN (SELECT [Id] FROM deleted); UPDATE [TapestryDesigner_ResourceItems] SET [BootstrapPageId] = NULL WHERE [BootstrapPageId] IN (SELECT [Id] FROM deleted); UPDATE [Tapestry_Blocks] SET [BootstrapPageId] = NULL WHERE [BootstrapPageId] IN (SELECT [Id] FROM deleted); DELETE FROM [MozaicBootstrap_Page] WHERE [Id] IN (SELECT [Id] FROM deleted); END");
            ...
            Sql("CREATE TRIGGER [TRG_C:TapestryDesigner_ResourceItems] ON [TapestryDesigner_ResourceItems] INSTEAD OF DELETE AS BEGIN DELETE FROM [TapestryDesigner_ResourceConnections] WHERE [SourceId] IN (SELECT [Id] FROM deleted) OR [TargetId] IN (SELECT [Id] FROM deleted); DELETE FROM [Tapestry_ResourceMappingPairs] WHERE [Source_Id] IN (SELECT [Id] FROM deleted) OR [Target_Id] IN (SELECT [Id] FROM deleted); DELETE FROM [TapestryDesigner_ConditionSets] WHERE [TapestryDesignerResourceItem_Id] IN (SELECT [Id] FROM deleted); DELETE FROM [TapestryDesigner_ResourceItems] WHERE [Id] IN (SELECT [Id] FROM deleted); END");
        ...
        public override void Down()
        {
            ...
            Sql("ALTER TABLE [TapestryDesigner_ConditionSets] ADD CONSTRAINT [FK_dbo.TapestryDesigner_ConditionSets_dbo.TapestryDesigner_ResourceItems_TapestryDesignerResourceItem_Id] FOREIGN KEY (TapestryDesignerResourceItem_Id) REFERENCES TapestryDesigner_ResourceItems(Id) ON DELETE SET NULL;");
            Sql("ALTER TABLE [TapestryDesigner_ConditionSets] ADD CONSTRAINT [FK_dbo.TapestryDesigner_ConditionSets_dbo.TapestryDesigner_WorkflowItems_TapestryDesignerWorkflowItem_Id] FOREIGN KEY (TapestryDesignerWorkflowItem_Id) REFERENCES TapestryDesigner_WorkflowItems(Id) ON DELETE SET NULL;");
            Sql("ALTER TABLE [TapestryDesigner_WorkflowItems] ADD CONSTRAINT [FK_dbo.TapestryDesigner_WorkflowItems_dbo.TapestryDesigner_Blocks_TargetId] FOREIGN KEY (TargetId) REFERENCES TapestryDesigner_Blocks(Id) ON DELETE SET NULL;");
