    ...
    public partial class INIT : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.AppRoleId, t.ActionRuleId })
                .ForeignKey("dbo.Persona_AppRoles", t => t.AppRoleId)
                .ForeignKey("dbo.Tapestry_ActionRule", t => t.ActionRuleId)
                .Index(t => t.AppRoleId)
                .Index(t => t.ActionRuleId);
                ...
                c => new
                    {
                        ...
                        CssTemplate_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Mozaic_CssTemplates", t => t.CssTemplate_Id)
                .Index(t => t.Name, unique: true)
                .Index(t => t.CssTemplate_Id);
                ...
                c => new
                    {
                        ...
                        ColumnDisplayName = c.String(unicode: false),
                        Application_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Master_Applications", t => t.Application_Id)
                ...
                c => new
                    {
                        ...
                        LeftTableId = c.Int(nullable: false),
                        LeftColumnId = c.Int(nullable: false),
                        RightTableId = c.Int(nullable: false),
                        RightColumnId = c.Int(nullable: false),
                        DbSchemeCommitId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Entitron_DbColumn", t => t.LeftColumnId)
                .ForeignKey("dbo.Entitron_DbTable", t => t.LeftTableId)
                .ForeignKey("dbo.Entitron_DbColumn", t => t.RightColumnId)
                .ForeignKey("dbo.Entitron_DbTable", t => t.RightTableId)
                .ForeignKey("dbo.Entitron_DbSchemeCommit", t => t.DbSchemeCommitId)
                .Index(t => t.LeftTableId)
                .Index(t => t.LeftColumnId)
                .Index(t => t.RightTableId)
                .Index(t => t.RightColumnId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Master_Applications", t => t.ApplicationId)
                .ForeignKey("dbo.MozaicB_Page", t => t.MozaicBootstrapPageId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MozaicB_Components", t => t.ParentComponentId)
                .ForeignKey("dbo.MozaicB_Page", t => t.MozaicBootstrapPageId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MozaicB_Page", t => t.BootstrapPageId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        InputName = c.String(nullable: false, maxLength: 50, storeType: "nvarchar"),
                ...
                c => new
                    {
                        ...
                        ActionId = c.Int(nullable: false),
                        Order = c.Int(nullable: false),
                        InputVariablesMapping = c.String(maxLength: 200, storeType: "nvarchar"),
                        OutputVariablesMapping = c.String(maxLength: 200, storeType: "nvarchar"),
                    })
                ...
                c => new
                    {
                        ...
                        ModelId = c.Int(),
                        LastStartTask = c.DateTime(precision: 0),
                        LastEndTask = c.DateTime(precision: 0),
                        ApplicationId = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Master_Applications", t => t.ApplicationId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Mozaic_TemplateCategories", t => t.CategoryId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Mozaic_Css", t => t.CssId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Nexus_RabbitMQ", "ApplicationId", "dbo.Master_Applications");
            ...
            DropForeignKey("dbo.TapestryDesigner_ResourceItems", "BootstrapPageId", "dbo.MozaicB_Page");
            ...
            DropForeignKey("dbo.MozaicB_Page", "ParentApp_Id", "dbo.Master_Applications");
            DropForeignKey("dbo.Mozaic_Js", "MozaicBootstrapPageId", "dbo.MozaicB_Page");
            DropForeignKey("dbo.MozaicB_Components", "MozaicBootstrapPageId", "dbo.MozaicB_Page");
            DropForeignKey("dbo.MozaicB_Components", "ParentComponentId", "dbo.MozaicB_Components");
            ...
            DropIndex("dbo.Nexus_RabbitMQ", new[] { "ApplicationId" });
            ...
            DropIndex("dbo.MozaicB_Components", new[] { "MozaicBootstrapPageId" });
            DropIndex("dbo.MozaicB_Components", new[] { "ParentComponentId" });
            DropIndex("dbo.MozaicB_Page", new[] { "ParentApp_Id" });
            ...
            DropTable("dbo.MozaicB_Components");
            DropTable("dbo.MozaicB_Page");
