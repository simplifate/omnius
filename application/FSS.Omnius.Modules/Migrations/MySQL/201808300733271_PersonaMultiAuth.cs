namespace FSS.Omnius.Modules.Migrations.MySQL
{
    ...
    public partial class PersonaMultiAuth : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("UPDATE `Persona_Users` SET `AuthTypeId` = CASE `isLocalUser` WHEN 1 THEN 0 WHEN 0 THEN 2 END");
        ...
        public override void Down()
        {
            ...
            Sql("UPDATE `Persona_Users` SET `isLocalUser` = CASE `AuthTypeId` WHEN 0 THEN 1 ELSE 0 END");
