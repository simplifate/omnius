...
namespace FSS.Omnius.Modules.Entitron
{
    ...
    {
        public const string connectionString = "data source=wv420273.rwegroup.cz;initial catalog=omnius;user id=Omnius;password=h.b3#:tTqKf8;MultipleActiveResultSets=True;App=EntityFramework";
