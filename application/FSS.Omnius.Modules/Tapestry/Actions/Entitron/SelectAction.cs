...
namespace FSS.Omnius.Modules.Tapestry.Actions.Entitron
{
	...
	public class SelectAction : Action
	{
		...
		public override string[] InputVar => new string[] { "TableName", "?SearchInShared", "?Top", "?OrderBy", "?Descending", "?GroupBy", "?GroupByFunction", "CondColumn[index]", "CondValue[index]", "?CondOperator[index]" };
